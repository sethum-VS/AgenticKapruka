# AgenticKapruka Documentation

Documentation for AgenticKapruka follows the [Diataxis](https://diataxis.fr/) framework. Pick the doc type that matches what you need right now.

## By reader

### Business and product

You want to understand what the product does, why it was built this way, and what customers can accomplish.

| Document | Type | Start here if… |
| --- | --- | --- |
| [Product overview](explanation-product-overview.md) | Explanation | You need a stakeholder summary |
| [Shopping journey](explanation-shopping-journey.md) | Explanation | You care about the customer experience |
| [Customer capabilities](reference-customer-capabilities.md) | Reference | You need a feature checklist |

### Shoppers and QA testers

You want to use the assistant or verify flows end to end.

| Document | Type | Start here if… |
| --- | --- | --- |
| [First conversation tutorial](tutorial-first-conversation.md) | Tutorial | You have never used the chat before |
...
You want to run, extend, or deploy the system.

| Document | Type | Start here if… |
| --- | --- | --- |
| [Developer setup](howto-developer-setup.md) | How-to | You are setting up locally |
| [Architecture](explanation-architecture.md) | Explanation | You need design rationale |
| [HTTP API reference](reference-http-api.md) | Reference | You are integrating with routes |
...
- **README.md** — project home with architecture diagram and module index
